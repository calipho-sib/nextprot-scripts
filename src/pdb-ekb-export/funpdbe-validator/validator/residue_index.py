...
class ResidueIndexes(object):
    ...
    def _process_residues(self, residues, depositor_residue_number, depositor_aa_type, depositor_chain_id):
        ...
        self.mismatches.append(
            "residue numbering is completely mismatched between data and PDB entry [%s] (invalid residue: %s_%s_%s)" % (
                self.pdb_id, depositor_chain_id, depositor_residue_number, depositor_aa_type))
        return False
